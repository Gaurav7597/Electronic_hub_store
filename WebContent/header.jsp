...
<%@ page import="com.ElectronicHubStore.service.impl.*, com.ElectronicHubStore.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #138496; color: white; padding: 5px;">
		<h2>Electronic Hub Store</h2>
